...
namespace Engine {
	...
	public:
		...
		* @param position The coordinates of the Camera's location
		* @param target The coordinates of the Camera's target location
		* @param upvector Vector for describing the upper side of the camera
		*/
